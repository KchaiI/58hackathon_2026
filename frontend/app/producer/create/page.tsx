...
export default function CreateListingPage() {
  ...
  function fillDemo() {
    const demoImageUrl =
      "https://jzswmjdszahjlanbiquc.supabase.co/storage/v1/object/public/listing-images/stroberry.jpg";
    setForm({
      producerName: "栃木いちご農園",
      location: "栃木県宇都宮市",
      email: "demo2@example.com",
      title: "栃木産とちおとめの支援者になろう",
      crop: "イチゴ",
      description:
        "栃木が誇るブランドいちご「とちおとめ」を一緒に育てませんか。温室栽培で丁寧に育てた完熟いちごを収穫期にお届けします。支援者には栽培の様子を写真付きで定期レポートします。",
      price: "30000",
      totalSlots: "15",
  ...
  const inputClass =
    "w-full bg-[#f0f4f8] rounded-xl px-4 py-3 text-base text-black placeholder:text-gray-400 focus:outline-none border border-black transition";
      ...
      <div className="max-w-2xl mx-auto">
        <div className="flex items-center justify-between mb-1">
          ...
          <button
            type="button"
            onClick={fillDemo}
            className="text-sm px-4 py-2 rounded-xl border border-black text-black hover:bg-gray-100 transition"
          >
            デモ情報を入力
          </button>
        </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="例：farm@example.com"
                  className={inputClass}
                />
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400 mt-1.5">
                  海外の支援者にはAIが翻訳して届けます。ふだんの言葉で大丈夫です。
                </p>
              </div>
